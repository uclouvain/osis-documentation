...
**Organisation de formation (OF)** : toute organisation qui soutient un processus d’apprentissage, et dont le contenu est un ensemble structuré d’UE et d’OF de niveaux inférieurs. Types d'OF :
