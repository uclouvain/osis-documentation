...
** 	une _Finalité_ ne peut être incluse que dans le contenu d'un et un seul _Intitulé principal_, et dans le contenu d'une et une seule  _Orientation_ (qui peut être muette) ; 
