...
The following steps describe how to install Odoo from the source code in a Debian-based system (Linux Debian, Ubuntu, Mint, etc.), the platform we use to develop.
