...
(1)	que les types d’UE classifient la manière dont les étudiants les abordent, la procédure à suivre pour s’y inscrire ;
(2)	que des sous-types permettent d’autres distinctions, nécessaires à différents processus impliquant es UE.
...
magistral (CM) et les travaux pratiques (TP). Les UE de type mémoire et
stage ne comportent qu’un seul composant.
