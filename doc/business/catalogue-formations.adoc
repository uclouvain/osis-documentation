...
image:image/UE_Composition_principe_tableau1.png[]
...
LBIOL 1515	CM	TP
Composant	/C	/D	/T	/U
Inclusion de composant	Incluant	-> /C	Incluant	-> /T
	/C01	/C02	/D01	/T01	/T02	/T03	/T04	/U01
Inclusion de classe		incluante	-> /C02			incluante		-> /T03
Cours principal
Z	X	X		X	X	X	X
Partim A	X
Partim B		(+)	X			(+)		X
...
10h	/V
20h
Inclusion de composant	Incluant	-> /C	-> /C	Incluant	-> /T	-> /T
Classe	/C01	/C02	/D01	/E01	/T01	/T02	/T03	/T04	/U01	/V01	/V02
Inclusion de classe		incluante	-> /C02	-> /C01			incluante	incluante	-> /T03	-> /T04	autono.
Cours princ. Z	X	X			X	X	X	X
Partim A	X
Partim B		(+)	X				(+)		X
Partim C	(+)			X				(+)		X	X
