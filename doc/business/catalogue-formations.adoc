...
* et dont le contenu est un ensemble structuré d’UE et d’OF de niveaux inférieurs. 
...
Une _OF_ possède des attributs et un contenu, liste d'OF et/ou d'UE.
...
n'existe que dans le contexte d'une et une seule de ces _Orientations_ ; 
