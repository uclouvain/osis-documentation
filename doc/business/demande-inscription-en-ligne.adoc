...
+
image::images/demande_d_inscription/choisir_l_offre_d_etude_state7.png[]
+
Si le candidat répond "Oui" à la question de l'examen de maîtrise de la langue française, les autres questions apparaissent
+
image::images/demande_d_inscription/choisir_l_offre_d_etude_state72.png[]
+
...
+
image::images/demande_d_inscription/choisir_l_offre_d_etude_state6.png[]
+
*Offre doctorats*
+
...
+
image::images/demande_d_inscription/remplir_enquete_sociologique_state2.png[]
+
...
- Master en 60 crédit, Master en 180 ou en 240 crédits, Master en 120 crédits à finalité didactique, Master en 120 crédits à finalité didactique, Master en 120 crédits à finalité spécialisée: http://www.uclouvain.be/357538.html +
...
* Texte
+
image::images/demande_d_inscription/composantsDynamiques/texte.png[]
+
* Champ de texte libre
+
image::images/demande_d_inscription/composantsDynamiques/champTexte.png[]
* Zone de texte libre
+
image::images/demande_d_inscription/composantsDynamiques/zoneTexte.png[]
* Lien hypertexte
+
image::images/demande_d_inscription/composantsDynamiques/lien.png[]
* Pièce jointe: peut etre une image ou un pdf
+
image::images/demande_d_inscription/composantsDynamiques/pieceJointe.png[]
+
* Check box: qui peut contient un ou plusieurs lignes. Il peut avoir 1 ou plusieurs réponses
+
image::images/demande_d_inscription/composantsDynamiques/checkbox.png[]
+
