...
Une _OF_ est une organisation qui soutient un processus d’apprentissage,
...
toujours un intitulé ; les composantes Orientation et Finalité peuvent soit
rester _muettes_, soit être _nommées_.
...
* 	une Mini-formation peut être incluse dans le contenu de plusieurs Choix de mini-formations, appartenant à des formations différentes
